...
const Home = () => {
  ...
  const slides = [
    { image: pic1, title: "Achieve Your Financial Freedom 💰", subtitle: "Manage your money smartly and build your future with confidence." },
    { image: pic2, title: "Plan, Save, and Grow 📈", subtitle: "Track income & expenses, and make every penny count." },
    { image: pic3, title: "Invest in Your Dreams 🌟", subtitle: "Start small today and build a better tomorrow." },
    { image: pic1, title: "Your Money, Your Control 💼", subtitle: "Stay in charge of your financial journey with smart planning." },
    { image: pic2, title: "Budget Smarter, Live Better 🧮", subtitle: "Simple budgeting can change your financial life." },
          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center">
                ...
                <p className="text-xl md:text-2xl max-w-2xl px-4 text-gray-100 drop-shadow">{slide.subtitle}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-gray-300 py-16 border-4 border-gray-400 px-4 mt-8 shadow-md">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center gap-10">
          ...
          <div className="flex justify-center">
            <img className="w-[350px] md:w-[400px] shadow-md" src={pic4} alt="Budgeting Tips" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-300 border-4 border-gray-400 py-16 px-4 mt-8 shadow-md">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center gap-10">
          ...
          <div className="order-1 md:order-2">
            <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center md:text-left">Why Financial Planning Matters? 🤔</h2>
            <p className="text-gray-600 text-lg leading-relaxed text-center md:text-left">
              Financial planning helps you achieve your life goals, reduces stress, ensures better decision-making, and prepares you for unexpected events. Start planning today to secure a better tomorrow.
            </p>
          </div>
        </div>
      </section>
